...
async function vectorIndex(
  ...
  try {
    ...
    // Fork: route embedding through the HTTP embed pool (Ollama / llama-server /
    // in-process workers) when QMD_EMBED_URLS / QMD_OLLAMA_URLS or
    // embed-backends.yaml configures one; otherwise use the local LlamaCpp path.
